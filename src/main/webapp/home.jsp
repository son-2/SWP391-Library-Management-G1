                                                ...
                                                <c:when test="${sessionScope.user!= null}">
                                                    <li class="nav-item">
                                                        <a class="nav-link disabled" href="#" style="pointer-events:none;">
                                                            Hello, ${sessionScope.user.fullName != null ? sessionScope.user.fullName : sessionScope.user.username}
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
...
<section class="search-filters">
    <div class="container">
        <div class="filter-box">
            ...
            <form action="http://libraria.demo.presstigers.com/home.jsp" method="get">
