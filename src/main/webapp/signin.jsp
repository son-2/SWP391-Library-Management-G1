                    ...
                    <div class="woocommerce">
                        <div class="woocommerce-login">
                            <div class="company-info signin-register">
                                <div class="col-md-5 col-md-offset-1 border-dark">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="company-detail bg-dark margin">
                                                ...
                                                <form class="login" method="post" action="${pageContext.request.contextPath}/Signin">
                                                    ...
                                                    <div class="password-form-row">
                                                        ...
                                                        <p class="lost_password">
                                                            <a href="${pageContext.request.contextPath}/forgot-pin">Lost your Pin?</a>
                                                        </p>
                                                    </div>
